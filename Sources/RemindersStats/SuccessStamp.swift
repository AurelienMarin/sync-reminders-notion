...
struct SuccessStamp: Sendable {
    var url: URL
    var minimumInterval: TimeInterval

    init(url: URL, minimumInterval: TimeInterval = 12 * 3600) {
        self.url = url
        self.minimumInterval = minimumInterval
    }

    func shouldSkip(now: Date, force: Bool) -> Bool {
    ...
    func markSuccess(at date: Date) throws {
